...
const VoiceClaimReport = () => {
  ...
  return <div className="h-full bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="h-full max-w-md mx-auto flex flex-col">
          ...
          {showPhotoUpload && <div className="space-y-4">
              <Card className="p-4 bg-white border border-gray-200">
                <div className="space-y-4">
                  ...
                  {/* Continue Button */}
                  {uploadedPhotos.length > 0 && <Button onClick={handleContinueFromPhotos} className="w-full bg-green-600 hover:bg-green-700 text-white">
                      Weiter
                    </Button>}
                </div>
              </Card>
        ...
        {/* Completion State */}
        {currentStep === 'completed' && <div className="p-4">
