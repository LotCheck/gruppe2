...
const StepNavigation = ({ currentStep }: StepNavigationProps) => {
  const steps = [
    { id: 'voice', title: 'Schaden beschreiben', shortTitle: 'Beschreibung', icon: Mic },
    { id: 'photos', title: 'Fotos aufnehmen', shortTitle: 'Fotos', icon: Camera },
    { id: 'analysis', title: 'KI-Analyse', shortTitle: 'Analyse', icon: FileText },
    { id: 'preview', title: 'Bestätigung', shortTitle: 'Bestätigung', icon: CheckCircle }
  ];

  return (
    <div className="mb-6 max-w-4xl mx-auto px-2">
      {/* Mobile Progress Bar */}
